...
module id(
    ...
    // 000: LB      100: SB（修正为3'b101，原错误3'b105）
    // 001: LH      101: SH
    // 010: LW      110: SW
    // 011: LBU
    // 111: LHU
        ...
        case (opcode)
            ...
            7'b0000011: begin
                ...
                case(func3)
                    ...
                    3'b101: MemOp=3'b111; // LHU：半字加载（无符号）
                    default: illegal_instr = 1'b1; // 非法func3，标记非法指令
                endcase
            end
            ...
            7'b0100011: begin
                ...
                RegWr    = 1'b0;    // 禁止寄存器写回（关键修正）
                case(func3)
                    3'b000: MemOp=3'b100; // SB：字节存储（修正：3'b105→3'b101，移除非法字符5）
                    3'b001: MemOp=3'b101; // SH：半字存储
                    3'b010: MemOp=3'b110; // SW：字存储
                    default: illegal_instr = 1'b1; // 非法func3，标记非法指令
                endcase
            end
